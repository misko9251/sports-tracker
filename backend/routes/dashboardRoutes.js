...
router.post('/team/:teamId/player/:playerId/addContact', dashboardController.addContact)
router.get('/team/:teamId/player/:playerId/getPlayerVideos', dashboardController.getPlayerVideos)
router.get('/team/:teamId/player/:playerId/getPlayerContacts', dashboardController.getPlayerContacts)
